...
```bash
/home/willr/.codex/skills/openai-docs-mcp-cli/scripts/openai-docs-mcp.sh search "Responses API" 5
/home/willr/.codex/skills/openai-docs-mcp-cli/scripts/openai-docs-mcp.sh fetch https://platform.openai.com/docs/guides/migrate-to-responses
```
